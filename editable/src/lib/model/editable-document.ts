...
import { EditableDocumentData, EditableNodeType } from './editable-types';

export class EditableDocument extends EditableContent<EditableDocumentData> {
  // Makes sure always returning the appropiate type since EditableDoc is the default node type
  get type(): EditableNodeType { return 'document'; }
