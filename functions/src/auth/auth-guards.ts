...
export function isAuthorized(hasRole: string[], opts?: { allowSameUser?: boolean, rootEmail?: string }) {
    return (req: Request, res: Response, next: Function) => {
        ...
        // Authorize the user by root email
	    if (opts?.rootEmail && context.email === opts.rootEmail) {
